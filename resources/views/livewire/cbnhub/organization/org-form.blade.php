<div>
    ...
    <form class="space-y-4">
        ...
        <div class="grid grid-cols-4 sm:grid-cols-4 gap-4">
            ...
            <input type="checkbox" id="agree_tnc" wire:model.live="agree_tnc" class="mt-1 focus:ring-blue-500">
            <label for="agree_tnc" class="text-sm text-gray-700">
                Dengan ini kami menyatakan bersedia bekerjasama dengan SUPERBOOK sesuai dengan Komitmen SEKOLAH MINGGU
                SUPERBOOK. Data ini diserahkan penuh kepada SUPERBOOK untuk dipergunakan sebagai data penerima Materi
                ...
                @else
                    <button type="submit" wire:click.prevent="createOrganization" 
                        class=" bg-gray-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50" disabled>
                        Submit
                    </button>
                @endif
            @endif
